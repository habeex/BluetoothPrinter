...
public class PrinterService {
    ...
    public static PrinterService getInstance(Context context, Handler handler) {
     ...
     */
//    public IndividualPrinterService(Context context, Handler handler) {
//        mAdapter = BluetoothAdapter.getDefaultAdapter();
//        mState = STATE_NONE;
//        mHandler = handler;
//    }
    ...
    /**
     * Start the chat baidu.location.baidu. Specifically start AcceptThread to begin a
     ...
     *
     * @param device The BluetoothDevice to connectPrinter
     */
    public synchronized void connect(BluetoothDevice device) {
        if (D) Log.d(TAG, "connectPrinter to: " + device);
        ...
        // Start the thread to connectPrinter with the given device
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        // Cancel the accept thread because we only want to connectPrinter to one device
        if (mAcceptThread != null) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothActivity.TOAST, "Unable to connectPrinter device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                // Start the baidu.location.baidu over to restart listening mode
                PrinterService.this.start();
                return;
            }
        ...
        public void cancel() {
            try {
                ...
                Log.e(TAG, "close() of connectPrinter socket failed", e);
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(String buffer) {
            try {
                mmOutStream.write(buffer.getBytes("GBK"));
